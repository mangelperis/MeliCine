...
global $id;
$id = $_REQUEST['id'];
//Esto es porque el '+' da problemas
$id = str_replace("I D","I+D",$id);

//if ($id=='Calidad, Logística, Producción e I&#43;D'){
//$id ='Calidad, Logística, Producción e I+D';
//}else{}
...
if ( $id=='Informática' || $id=='Formación Ocupacional') {


$result1=mysql_query("SELECT Especialidad,NombreAF from $dBtabla WHERE Especialidad='$id' ORDER BY NombreAF ASC",$link);
...
//LO DEJO POR NO BORRAR COSAS PERO ESTO SOBRA (EL BUCLE IF)
...
$result10=mysql_query("SELECT * from $dBtabla WHERE Especialidad='$id' ORDER BY Especialidad,NombreAF,Titulo ASC",$link);	
