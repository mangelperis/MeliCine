...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 30-04-2015 a las 19:27:05
...
(6, 'Tomorrowland: El mundo del mañana', 19, 'US', 0, 'Brad Bird', 'George Clooney, Hugh Laurie, Britt Robertson, Raffey Cassidy, Judy Greer, Kathryn Hahn, Lochlyn Munro, Chris Bauer, Tim McGraw, Paul McGillion, Raiden Integra', 'Unidos por el mismo destino, un adolescente inteligente y optimista lleno de curiosidad científica y un antiguo niño prodigio inventor hastiado por las desilusiones se embarcan en una peligrosa misión para desenterrar los secretos de un enigmático lugar localizado en algún lugar del tiempo y el espacio conocido en la memoria colectiva como “Tomorrowland”.', 'TP', 'https://youtu.be/4sDYIehRoFc', 'Walt Disney Pictures', 2, '8b8374e6e7bc3003f8521eb18e56889a_Generic.jpg', '2015-05-29'),
